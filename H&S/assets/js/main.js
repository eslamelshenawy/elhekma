...
$('#price-range').slider({
   ...
   slide: function( event, ui ) {
	$('#price-amount').val( 'L.E ' + ui.values[ 0 ] + ' TO L.E ' + ui.values[ 1 ] );
   }
  });
$('#price-amount').val( 'L.E ' + $('#price-range').slider( 'values', 0 ) +
   ' TO L.E ' + $('#price-range').slider('values', 1 ) );
