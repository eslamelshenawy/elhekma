...
class effectiveMaterialController extends Controller
{
    ...
    {
        return $content
            ->header('Active Ingredient Details')
    ...
    {
        $show = new Show(effectiveMaterial::findOrFail($id));
    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header('Active Ingredients');
    ...
    public function edit($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            ...
            $content->header('Edit Active Ingredient');
            // $content->description('description');
    ...
    public function create()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header('Create New Active Ingredient');
            // $content->description('description');
    ...
    {
        return Admin::grid(effectiveMaterial::class, function (Grid $grid) {
    ...
    {
        return Admin::form(effectiveMaterial::class, function (Form $form) {
