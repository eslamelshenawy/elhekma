...
class tagsGroupController extends Controller
{
    ...
    {
        $show = new Show(tagsGroup::findOrFail($id));
    ...
    public function edit($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            ...
            $content->header('Edit Tags Group');
            // $content->description('description');
    ...
    public function create()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header('Create New Tags Group');
            // $content->description('description');
    ...
    {
        return Admin::grid(tagsGroup::class, function (Grid $grid) {
    ...
    {
        return Admin::form(tagsGroup::class, function (Form $form) {
