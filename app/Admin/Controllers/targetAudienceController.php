...
class targetAudienceController extends Controller
{
    ...
    {
        return $content
            ->header('Target Audience Details')
    ...
    {
        $show = new Show(targetAudience::findOrFail($id));
    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header('Target Audiences');
            // s
    ...
    public function edit($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            ...
            $content->header('Edit Target Audience');
    ...
    public function create()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header('Create New Target Audience');
            // $content->description('description');
    ...
    {
        return Admin::grid(targetAudience::class, function (Grid $grid) {
    ...
    {
        return Admin::form(targetAudience::class, function (Form $form) {
